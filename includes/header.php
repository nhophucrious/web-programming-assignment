...
<body>
    <nav class="navbar navbar-expand-lg bg-dark text-white sticky-top" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li
                    class="nav-item <?= strpos($uri ?? '', '/web-programming-assignment/jobs') === 0 ? 'active' : '' ?>">
